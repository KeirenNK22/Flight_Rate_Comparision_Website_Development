...
import BusList from '../FlightList/BusList'
export default function Routeselector() {
    ...
    const renderBusList = (dataInp) => {
       // dataInp.sort((a, b) => a.pricePerSeat - b.pricePerSeat);
    ...
    const getRoutes = e => {
        ...
        apiCall.getRoutesFromApi(startCity.startCity, destination.destination,flightDate)
