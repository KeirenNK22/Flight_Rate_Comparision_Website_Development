            ...
            <div className="row">
                ...
                <div className="column3" >
                    ...
                    <br/><br/>
                        ...
                        <center>
                            <br/>
                        <p class="te">EMAIL: tragos@gmail.com</p>
                    <p class="te">CONTACT NUMBER: 9390168893</p>
                    <p class="te">ADDRESS:siddaganga institute of technology,TUMKUR,KARNATAKA,572013 </p>
                    </center>
                        </center>
                        <br/><br/>
                        <p className='bo'>If you need any information send mail</p>

        <a href="mailto:1si20cs052@sit.ac.in" className='bo'>Report via mail</a><br></br>
